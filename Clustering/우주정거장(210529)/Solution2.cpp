...
* 10만개의 점들을 대상으로 farthest[100] 중에 하나가
  candi[0]보다 가까운 점들을 B[]에 구한다.(185개이다.)
* farthest[100]중에 2점을 candi[1], candi[2]라고 할 때,
...
3. solution sketch
    ...
    (2) A그룹 pivot으로 { 1.214, 1.205, 1.209 }; 원점으로부터 거리 6이하인 점들의 평균을 이용할 수 있다.
...
void getStation(double coordi[100000][3], int result[3])
{
    ans = INF;
    p = coordi;
    candi[0] = { 1.214, 1.205, 1.209 }; // 원점으로부터 거리가 6미만인 점들의 평균으로 구해진 좌표
